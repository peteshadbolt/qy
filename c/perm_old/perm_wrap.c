...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__perm

#else
#  define SWIG_init    init_perm

#endif
#define SWIG_name    "_perm"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_perm(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:perm",&obj0)) SWIG_fail;
  {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"perm", _wrap_perm, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
