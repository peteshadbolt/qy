...
camera{orthographic  right 6.4*x*.8    up 4.8*y*.8  location <2,2,2> look_at <0,0,0> sky <0,0,1>}

light_source {<-2,-2,5> color rgb <1,1,1> shadowless}   

plane{<0,0,1>, -2 pigment{color rgb <1,1,1>} finish{ ambient 0.2 diffuse 0.9}}
