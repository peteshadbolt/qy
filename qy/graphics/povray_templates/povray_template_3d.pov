...
camera{orthographic  right 6.4*x*.8    up 4.8*y*.8  location <-3,-1.5,2>*1 look_at <0,0,-.1> sky <0,0,1>}
...
plane{<0,0,1>, -2 pigment{color rgb <1,1,1>} finish{ ambient 0.5 diffuse 0.9}}
