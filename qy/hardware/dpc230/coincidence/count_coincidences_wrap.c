...
#define SWIG_init    Count_coincidences_Init
#define SWIG_name    "count_coincidences"
#define SWIG_prefix  ""
...
#endif
SWIGINTERN int
_wrap_process_spc(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  char *arg1 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  int alloc1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:process_spc spc_filename ",(void *)0) == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_set_delays(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int *arg1 = (int *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:set_delays new_delays ",(void *)0) == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_set_window(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:set_window new_window ",(void *)0) == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_set_time_cutoff_ms(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:set_time_cutoff_ms new_time_cutoff_ms ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "process_spc", (swig_wrapper_func) _wrap_process_spc, NULL},
    { SWIG_prefix "set_delays", (swig_wrapper_func) _wrap_set_delays, NULL},
    { SWIG_prefix "set_window", (swig_wrapper_func) _wrap_set_window, NULL},
    { SWIG_prefix "set_time_cutoff_ms", (swig_wrapper_func) _wrap_set_time_cutoff_ms, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Count_coincidences_SafeInit(Tcl_Interp *interp) {
